...
abstract class Client extends ClientBase {
  core.String basePath = "/latitude/v1/";
  ...
  CurrentLocationResource_ get currentLocation => new CurrentLocationResource_(this);
  LocationResource_ get location => new LocationResource_(this);
